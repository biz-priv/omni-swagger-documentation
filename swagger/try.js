...
(function (window, undefined) {
    ...
    loadScript("https://cdn.jsdelivr.net/npm/jquery@3.2.1/dist/jquery.min.js")
      ...
      .then(function () {
        ...
        if (cfg.onlySwagger) {
          ...
          (_Redoc = Redoc).init.apply(
            _Redoc,
            _toConsumableArray(cfg.redocOptions)
          );
        }
      })
      ["catch"](function () {
  ...
  function cfgHandle(userCfg) {
    ...
    var redocOptionsRes = dataType(redocOptions, "object")
  ...
  function trySwagger(cfg) {
    ...
    $(".tryBtn").click(function (event) {
      ...
      var appendSwaggerShadow = function appendSwaggerShadow() {
        return $(".try .fullApiBox").append(
          '<div class="swaggerShadow"></div>'
        );
      ...
      var selStr = ".opblock-summary-"
        .concat(method, ' [data-path="')
        .concat(api, '"]');
